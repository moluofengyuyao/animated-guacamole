 ...
 * @LastEditTime: 2024-05-22 11:24:38
    ...
    <header>
      <div class="header-left">
        <div class="logo-wrapper">
          <img src="~@/assets/images/header/ctgzLogo.png"/>
        </div>
      </div>
...
watch(
  () => route.name,
  () => {
    if(['WorkDynamics','WorkDynamicsList',
    'NoticeFileAdd','NoticeFileDetail',
    'TrainingPlanAdd','TrainingPlanDetail',
    'QuestionAnswerAdd','QuestionAnswerDetail',
    'TechnologyStandardAdd','TechnologyStandardDetail'].includes(route.name)){//工作动态
      useNav.changeActiveName('WorkDynamicsList')
    }else{//工作上报
      useNav.changeActiveName('WorkReport')
    }
  },
  {
